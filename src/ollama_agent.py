...
from database_module import seed_milvus, connect_to_milvus
...
def get_retriever(collection_name: str = "data_test", use_ollama: bool = False) -> EnsembleRetriever:
    """
    ...
    try:
        ...
        vectorstore = connect_to_milvus('http://localhost:19530', collection_name, use_ollama)
...
def get_llm_and_agent(retriever):
    ...
    system = """You are an expert at legal documents. Your name is Tiểu Vinh Hiền. 
                If the question is related to legal issues, call the find_document tool to retrieve legal documents. 
                Otherwise, respond based on your knowledge."""
