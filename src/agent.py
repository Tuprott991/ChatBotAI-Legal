...
from database_module import seed_milvus, connect_to_milvus  # Kết nối với Milvus
...
def get_retriever(collection_name: str = "data_test") -> EnsembleRetriever: # ép kiểu đầu ra
    """
    ...
    try:
        ...
        # Kết hợp hai retriever với tỷ trọng 70% milvus_retriever và 30% bm25
